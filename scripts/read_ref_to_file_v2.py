...
OUT_FILE = r"c:\Users\jlcue\Documents\mag-sistema\ref_excel_data.txt"

if not os.path.exists(FILE_PATH):
    with open(OUT_FILE, "w") as f: f.write(f"ERROR: File not found: {FILE_PATH}")
else:
    # Use load_workbook with read_only=True for faster loading if possible, 
    # but we need data_only=True to get formula results.
